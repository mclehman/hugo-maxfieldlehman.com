...
Somewhat predictably, the first thing I took care on here after making that "plans going forward" list was not even featured on said list: setting up HTTPS.
